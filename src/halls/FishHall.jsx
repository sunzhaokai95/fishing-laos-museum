...
export default function FishHall({ hall, data }) {
  ...
  return (
    <main className="museum-hall museum-hall--fish min-h-screen" data-motion-language="shoal">
      <div className="museum-hall-current" aria-hidden="true"><span className="fish-current fish-current-one" /><span className="fish-current fish-current-two" /></div>
